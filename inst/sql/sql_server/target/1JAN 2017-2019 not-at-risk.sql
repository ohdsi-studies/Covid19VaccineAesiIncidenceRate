...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45768812,46271022,192279,4263367,261071,201313,193253,195314,192359)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45768812,46271022,192279,4263367,261071,201313,195314,192359)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (197320,45769152,195289,43530912,4066005,37116834,195014,197930)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (197320,45769152,195289,43530912,4066005,37116834,195014,197930)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4320803)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4320803)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (317576,316995)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (317576,316995)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (321319)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (321319)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (36715355,4060985,4256640,433736,35623139)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (36715355,4060985,4256640,433736,35623139)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4060705,4062199,4062198,45766204,4176962,4152039,44789321,4081038,44807968)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4060705,4062199,4062198,45766204,4176962,4152039,44789321,4081038,44807968)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3038553,3031543)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3025315,4099154)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (22281)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (22281)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4242257,4208341,42537741)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4242257,4208341,42537741)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40766945,44805737,762882,4209423,44804580,44802794,4217594,44810931,4199818,4295004,4275495,4041306,4005823)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40766945,44805737,762882,4209423,44804580,44802794,4217594,44810931,4199818,4295004,4275495,4041306,4005823)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4036556,4038735,4218741,764468,765685,4052464,37017812,764470,4310250,4036560,4036085,4144272,4222303,4038731,4036084,4043053,4103418,4036087,37017610)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4036556,4038735,4218741,764468,765685,4052464,37017812,764470,4310250,4036560,4036085,4144272,4222303,4038731,4036084,4043053,4103418,4036087,37017610)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2617854,2101895,44786481,45890719,937682,937680,937686,40756893,915749,915750,915623,2617806,2108525,2108526)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2617854,2101895,44786481,45890719,937682,937680,937686,40756893,915749,915750,915623,2617806,2108525,2108526)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42739743,2101807,2004526,2004525,4014461,4151169,4149449,4149457,4149451,4014299,4150406,4150405,4150404,4028644,4216316,4192676,193277,444113,441641,4128030,2004489,4138740,4074867,4195545,4170151,4282169,194694,436228,75605,4148097,4118056,4063309,72726,40482735,4171115,2721012,433260,440847,4194423,441128,432695,437369,440833,40539858,4086393,4147874,4064709,4058403,36712702,4150401,4153287,4086797,4170121,136530,2514572,2514571,42740403,2514570,4297250,2110328)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (42739743,2101807,2004526,2004525,4014461,4151169,4149449,4149457,4149451,4014299,4150406,4150405,4150404,4028644,4216316,4192676,193277,444113,441641,4128030,2004489,4138740,4074867,4195545,4170151,4282169,194694,436228,75605,4148097,4118056,4063309,72726,40482735,4171115,2721012,433260,440847,4194423,441128,432695,437369,440833,40539858,4086393,4147874,4064709,4058403,36712702,4150401,4153287,4086797,4170121,136530,2514572,2514571,42740403,2514570,4297250,2110328)
  and c.invalid_reason is null
...
select C.person_id, C.observation_period_id as event_id, CAST('2017-01-01' as Date) as start_date, CAST('2017-01-01' as Date) as end_date,
...
WHERE C.OBSERVATION_PERIOD_START_DATE <= CAST('2017-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2017-01-01' as Date)
AND C.OBSERVATION_PERIOD_START_DATE <= CAST('2017-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2017-01-01' as Date)
-- End Observation Period Criteria

UNION ALL
-- Begin Observation Period Criteria
select C.person_id, C.observation_period_id as event_id, CAST('2018-01-01' as Date) as start_date, CAST('2018-01-01' as Date) as end_date,
       C.period_type_concept_id as TARGET_CONCEPT_ID, CAST(NULL as bigint) as visit_occurrence_id,
       C.observation_period_start_date as sort_date
...
WHERE C.OBSERVATION_PERIOD_START_DATE <= CAST('2018-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2018-01-01' as Date)
AND C.OBSERVATION_PERIOD_START_DATE <= CAST('2018-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2018-01-01' as Date)
-- End Observation Period Criteria

UNION ALL
-- Begin Observation Period Criteria
select C.person_id, C.observation_period_id as event_id, CAST('2019-01-01' as Date) as start_date, CAST('2019-01-01' as Date) as end_date,
       C.period_type_concept_id as TARGET_CONCEPT_ID, CAST(NULL as bigint) as visit_occurrence_id,
       C.observation_period_start_date as sort_date
...
WHERE C.OBSERVATION_PERIOD_START_DATE <= CAST('2019-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2019-01-01' as Date)
AND C.OBSERVATION_PERIOD_START_DATE <= CAST('2019-01-01' as Date) and C.OBSERVATION_PERIOD_END_DATE >= CAST('2019-01-01' as Date)
-- End Observation Period Criteria
...
WHERE (C.value_as_number >= 30.0000 and C.value_as_number <= 60.0000)
...
(
  select m.* 
  FROM @cdm_database_schema.MEASUREMENT m
JOIN #Codesets codesets on ((m.measurement_concept_id = codesets.concept_id and codesets.codeset_id = 9))
) C
...
(
  select o.* 
  FROM @cdm_database_schema.OBSERVATION o
JOIN #Codesets codesets on ((o.observation_concept_id = codesets.concept_id and codesets.codeset_id = 9))
) C
...
UNION ALL
-- Begin Correlated Criteria
SELECT 14 as index_id, p.person_id, p.event_id
FROM #qualified_events P
LEFT JOIN
(
  -- Begin Condition Occurrence Criteria
...
UNION ALL
-- Begin Correlated Criteria
SELECT 15 as index_id, p.person_id, p.event_id
FROM #qualified_events P
LEFT JOIN
(
  -- Begin Condition Occurrence Criteria
...
UNION ALL
-- Begin Correlated Criteria
SELECT 16 as index_id, p.person_id, p.event_id
FROM #qualified_events P
LEFT JOIN
(
  -- Begin Observation Criteria
...
WHERE C.value_as_concept_id in (4188539,45877994,0)
-- End Observation Criteria
...
UNION ALL
-- Begin Correlated Criteria
SELECT 17 as index_id, p.person_id, p.event_id
FROM #qualified_events P
LEFT JOIN
(
  -- Begin Observation Criteria
...
UNION ALL
-- Begin Correlated Criteria
SELECT 18 as index_id, p.person_id, p.event_id
FROM #qualified_events P
LEFT JOIN
(
  -- Begin Condition Occurrence Criteria
...
UNION ALL
-- Begin Criteria Group
select 19 as index_id, person_id, event_id
FROM
(
  select E.person_id, E.event_id 
  FROM #qualified_events E
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-270,P.START_DATE) AND A.START_DATE <= DATEADD(day,0,P.START_DATE)
GROUP BY p.person_id, p.event_id
HAVING COUNT(A.TARGET_CONCEPT_ID) = 0
-- End Correlated Criteria
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.END_DATE >= DATEADD(day,-270,P.START_DATE) AND A.END_DATE <= DATEADD(day,0,P.START_DATE)
GROUP BY p.person_id, p.event_id
HAVING COUNT(A.TARGET_CONCEPT_ID) = 0
-- End Correlated Criteria
...
(
  select o.* 
  FROM @cdm_database_schema.OBSERVATION o
JOIN #Codesets codesets on ((o.observation_concept_id = codesets.concept_id and codesets.codeset_id = 16))
) C
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,1,P.START_DATE) AND A.START_DATE <= DATEADD(day,270,P.START_DATE)
GROUP BY p.person_id, p.event_id
HAVING COUNT(A.TARGET_CONCEPT_ID) = 0
-- End Correlated Criteria
...
select event_id, person_id, 
  case when DATEADD(day,364,start_date) > start_date then DATEADD(day,364,start_date) else start_date end as end_date
INTO #strategy_ends
